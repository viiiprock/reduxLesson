...
Chúng ta đã kết thúc bài tập cơ bản về redux và cách liên kết với các component của react. Sau khi dispatch action, các state được cập nhật ngay lập tức. Đây gọi là xử lý đồng bộ (synchronous)

Còn xử lý bất đồng bộ (asynchronous) thì sao? Chúng ta sẽ tiếp tục tìm hiểu ở phần sau. 
